class LinkedIn{
 public static String userRegistration(String firstName, String lastName, String phoneNumber, String dob, String gender, String password, String confirmPassword, String email) {
        String ref = null;
        boolean userValid = validateUserProfile(firstName, lastName, phoneNumber, dob, gender, password, confirmPassword, email);
    ...
    public static boolean validateUserProfile(String firstName, String lastName, String phoneNumber, String dob, String gender, String password, String confirmPassword, String email) {
        ...
        if (isFirstNameValid==true && isLastNameValid==true && isPhoneNumberValid==true && isDobValid==true && isGenderValid==true && isPasswordValid==true&& isConfirmPasswordValid==true && isEmailValid==true) {
            userValid = true;
        }
