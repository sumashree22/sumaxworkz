class Myntra {
    ...
    public static String userRegistration(String firstName, String lastName, String phoneNumber, String dob, String gender, String password, String confirmPassword) {
        String ref = null;
